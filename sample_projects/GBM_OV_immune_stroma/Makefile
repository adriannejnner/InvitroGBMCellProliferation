...
PROGRAM_NAME := GBM_OV_immune_stroma
...
PhysiCell_custom_module_OBJECTS := GBM_OV_immune_stroma.o
...
GBM_OV_immune_stroma.o: ./custom_modules/GBM_OV_immune_stroma.cpp 
	$(COMPILE_COMMAND) -c ./custom_modules/GBM_OV_immune_stroma.cpp
