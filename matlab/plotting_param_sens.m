function plotting_param_sens(Diff01,Diff05,Diff1,Diff15,Diff2,Diff100)
...
c = colorbar
colormap(cmap)
set(c,'ticks',[0.0833,0.25,0.41667,0.5835,0.7502,0.9166],'ticklabels',{'D_{virus}{\times}0.1','D_{virus}{\times}0.5','D_{virus}{\times}1','D_{virus}{\times}1.5','D_{virus}{\times}2','D_{virus}{\times}10'})
