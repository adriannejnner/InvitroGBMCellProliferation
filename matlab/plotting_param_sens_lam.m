...
c = colorbar
colormap(cmap)
set(c,'ticks',[0.0833,0.25,0.41667,0.5835,0.7502,0.9166],'ticklabels',{'\lambda_{virus}{\times}0.1','\lambda_{virus}{\times}0.5','\lambda_{virus}{\times}1','\lambda_{virus}{\times}1.5','\lambda_{virus}{\times}2','\lambda_{virus}{\times}10'})
